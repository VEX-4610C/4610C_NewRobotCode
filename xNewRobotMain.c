...
#pragma config(Motor,  port7,           frontLeft,     tmotorVex393_MC29, openLoop, encoderPort, I2C_2)
#pragma config(Motor,  port8,           frontRight,    tmotorVex393_MC29, openLoop, encoderPort, I2C_1)
...
task autonomous()
{
	...
	if(MyAutonomous == 8 || (RUNTEST == 1 && TEST == 11))
		stationaryAuto();
	if(MyAutonomous == 9 || (RUNTEST == 1 && TEST == 12))
		stationaryPlusFive(LEFT);
	if(MyAutonomous == 10 || (RUNTEST == 1 && TEST == 13))
		stationaryPlusFive(RIGHT);
	if(MyAutonomous == 11 || (RUNTEST == 1 && TEST == 14))
		disruptAuto();
	if(RUNTEST == 1 && TEST == 15)
